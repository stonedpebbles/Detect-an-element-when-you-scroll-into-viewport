(function ($) {
    var $window = $(window),
        _watch = [],
        _buffer, pluginName = 'scrolledIntoView',
        settings = {
            scrolledin: null,
            scrolledout: null
        },
        ...
        monitor = function (element, options) {
            var item = {
                element: element,
                options: options,
                invp: false
        ...
        binds = function ($el) {
            $el.on('scrolledin scrolledout remove', function (evt) {
                var $this = $(this),
                    scrolled = {
